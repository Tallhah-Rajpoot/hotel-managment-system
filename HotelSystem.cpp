...
int main(){
	...
	robj.NewRacipee("chai",30,"shahir");
	robj.NewRacipee("samosa",30,"eman");
	robj.NewRacipee("biryani",30,"hell");


	robj.NewRacipee("chiken",30,"ali");
	robj.NewRacipee("korma",30,"umair");
	robj.NewRacipee("kadhai",30,"usman");


	rmobj.NewGest("1","Tallhah","2-2-2022","couple","1 month","lahore");
	rmobj.NewGest("2","usman","2-2-2022","couple","1 month","lahore");
	rmobj.NewGest("3","shahir","2-2-2022","couple","1 month","lahore");
	rmobj.NewGest("4","anas","2-2-2022","couple","1 month","lahore");
	rmobj.NewGest("5","shero","2-2-2022","couple","1 month","lahore");


	wobj.NewWorker("1","tallhah",700,"03118897764");
	wobj.NewWorker("2","muhmmad",700,"03118897764");
	wobj.NewWorker("3","ali",700,"03118897764");
	wobj.NewWorker("4","hassan",700,"03118897764");
	wobj.NewWorker("5","hussain",700,"03118897764");
